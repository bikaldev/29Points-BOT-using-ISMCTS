...
constexpr int32_t RankOrder(Rank rank)
{   
    constexpr int32_t rank_order[] = {0,1,6,4,7,2,3,5};
    return rank_order[(int32_t)rank - (int32_t)Rank::SEVEN];
}
...
public:
    ...
    {
        std::string        name(2, ' ');
        static const char *val = "789TJQK1R";
